...
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    code: '05',
    icon: Zap,
    description: 'Where forced flow breaks liquidity — instability, cascades & forced-flow collision',
    group: 'Main',
  },
  {
    path: '/lotto',
    ...
    code: '06',
    icon: Ticket,
    description: 'Same-day speculation — 0DTE contracts & the closing-auction (MOC) engine',
    group: 'Main',
  },
  {
    path: '/prove-it',
