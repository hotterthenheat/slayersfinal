...
const Compass = () => {
  ...
  */
  ...
  /*
    ...
    verbatim — title "Trade Setups" and the browse subtitle. So arriving here
    from "Monitor strike" on the Trace drawer, or from Review in the Tracker,
    put the signal monitor on screen under a header still claiming you were
    browsing the setups feed. The destination was right and the wayfinding was
    wrong. It now names the contract being watched.
  */
  const reviewHeader = (
    <PageHeader
      title={
