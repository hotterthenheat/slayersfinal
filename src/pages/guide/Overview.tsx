...
const DESKS: { icon: LucideIcon; name: string; to: string; blurb: string }[] = [
  ...
  { icon: Compass, name: 'Compass', to: '/compass', blurb: 'Finds the setup — a ranked same-day board, plus a weigher for any contract you name.' },
  ...
  { icon: Sigma, name: 'Prove It', to: '/prove-it', blurb: 'The receipts — quant modeling, and how the engines this desk can grade have tracked.' },
];
...
const STEPS = [
  ...
  <>Pick a ticker from the top bar — or press <Kbd>]</Kbd> / <Kbd>[</Kbd> to step through the watchlist. Pulse, Compass, Pinpoint, Prove It, News and Tracker rebuild around it, and so do Trace's Dark pool and Scanner. Stocks and Earnings survey the whole field rather than one name, and Trace's Live tape and Reconstruction stay on the same prints — the top bar hides the switcher wherever it would not change the page.</>,
