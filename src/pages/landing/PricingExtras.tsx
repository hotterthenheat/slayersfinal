...
const FAQS = [
  ...
  {
    q: 'Is the data live?',
    a: 'The terminal currently runs on a preview feed while we finish the platform — every panel, engine and animation is the real product. Live market data lands with launch, and nothing about the interface changes when it does.',
  },
  {
