...
const SCENE_SPEC: (Omit<TrailerSceneDefinition, 'enterAtMs' | 'exitAtMs'> & { storyEnd: number })[] = [
  ...
  { storyEnd: 0.74, id: 'compass', product: 'Compass · Setups', route: '/compass', durationMs: 5200, description: 'Candidate setups inherit the market state; the one with the best flow score is rejected on data quality.' },
